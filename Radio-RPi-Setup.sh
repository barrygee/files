...
if [ "$raspi_config_updated" = false ]; then
    ...
    echo 'sudo sh -c "echo 1350 > /sys/module/usbcore/parameters/usbfs_memory_mb"' >> ~/.bashrc
    ...
    echo "screen bash -ic 'rtl_tcp -d 1 -a $rpi_ip_address -s $rtl_tcp_sample_rate -b 100'" >> .screenrc-sdr
